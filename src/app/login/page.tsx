      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          <Link href="/" className="inline-flex items-center gap-2 group">
            <div className="w-9 h-9 bg-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-blue-600/30">
              G
            </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
          ...
          {message && (
            <div className="mb-5 flex items-start gap-3 p-3.5 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 hover:border-zinc-600 text-white rounded-xl py-3 px-4 text-sm font-medium transition-all duration-150 disabled:opacity-40 disabled:cursor-not-allowed mb-5"
          >
            {googleLoading ? (
          ...
          <div className="relative mb-5">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 bg-zinc-900 text-zinc-600 text-xs">or continue with email</span>
            </div>
          </div>
...
function getFriendlyError(msg: string): string {
  ...
  if (msg.includes('User not found')) return 'No account found with this email. Please create an account.'
  return msg
}
